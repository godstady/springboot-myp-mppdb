...
//        System.out.println(json.get("data"));
        ...
        String cc ="2345";
        //发送 GET 请求
        String s=HttpUtil.sendGet("http://127.0.0.1:8060/api/data/testApi?wjbh="+aa+"&wjbm="+cc,"");
        System.out.println(s);
        //发送 POST 请求
        String s3=HttpUtil.sendPost("http://127.0.0.1:8060/api/data/testApi2","wjbh="+aa+"&wjbm="+cc);
